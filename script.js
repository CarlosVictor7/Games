...
verificar.onclick = function(){
  if(document.getElementById("uf").value == 'PA'){
    window.alert("O frete é de R$3,00");
    ...
    window.alert("O frete é de R$7,00");
    ...
    window.alert("O frete é de R$7,50");
    ...
    window.alert("O frete é R$10,00");
